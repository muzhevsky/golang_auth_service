...
func (u *selectUserDataByAccountIdPGCommand) Execute(context context.Context, accountId int) (*user_data_entities.UserData, error) {
	...
	var result user_data_entities.UserData
