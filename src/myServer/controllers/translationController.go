...
type translationController struct {
	repository *repositories.TranslationRepository
}

func NewTranslationController(repository *repositories.TranslationRepository) *translationController {
